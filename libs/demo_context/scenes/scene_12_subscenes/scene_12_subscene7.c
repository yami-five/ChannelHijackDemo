...
static void unload_assets_subscene7(e3d_EngineContext *engine_ctx,
  ...
  e3d_Mesh_DeleteMesh(engine_ctx, &subscene_assets->wasp_body);
  e3d_Mesh_DeleteMesh(engine_ctx, &subscene_assets->wasp_planet);
  e3d_Mesh_DeleteMesh(engine_ctx, &subscene_assets->wasp_wing_left);
  e3d_Mesh_DeleteMesh(engine_ctx, &subscene_assets->wasp_wing_right);
